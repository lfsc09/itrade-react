...
const modulos = [
    {
        ...
        sub_item: false,
        matches: ['renda variavel', 'dash', 'dashboard'],
    },
    {
        id: 2,
        ...
        grupo: 'Renda Variável',
        sub_item: true,
        matches: ['novo operacao', 'nova operacao', 'operacao', 'cadastro operacao'],
    },
    {
        id: 3,
        ...
        grupo: 'Renda Variável',
        sub_item: true,
        matches: ['importar operacao'],
    },
    { id: 4, label: 'Datasets', url: '/daytrade/datasets', icon: <Storage fontSize='small' />, grupo: 'Renda Variável', sub_item: false, matches: ['datasets'] },
    { id: 5, label: 'Ativos', url: '/daytrade/ativos', icon: <Euro fontSize='small' />, grupo: 'Renda Variável', sub_item: false, matches: ['ativos'] },
    { id: 6, label: 'Gerenciamentos', url: '/daytrade/gerenciamentos', icon: <LocalAtm fontSize='small' />, grupo: 'Renda Variável', sub_item: false, matches: ['gerenciamentos'] },
    { id: 7, label: 'Cenários', url: '/daytrade/cenarios', icon: <Grading fontSize='small' />, grupo: 'Renda Variável', sub_item: false, matches: ['cenarios'] },
    { id: 8, label: 'Builds', url: '/daytrade/builds', icon: <Science fontSize='small' />, grupo: 'Renda Variável', sub_item: false, matches: ['builds'] },
];
